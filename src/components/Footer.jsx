        ...
        <div className="flex flex-col space-y-6 lg:grid lg:grid-cols-4 lg:gap-8 lg:space-y-0">
          ...
          <motion.div className="lg:col-span-1" variants={columnVariants} custom={0}>
            <motion.div className="mb-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.28, ease: 'easeOut' } }} viewport={{ once: true, amount: 0.35 }}>
              ...
              <p className="text-sm text-[#FFD600] font-medium mb-3">
                Quality Steel Solutions
              </p>
              <p className="text-gray-300 text-sm leading-relaxed">
                Ground Floor, Wz-18, Khyala Village, Khayala Village, New Delhi-110018, Delhi, India<br/>
          ...
          <motion.div className="grid grid-cols-2 gap-4 lg:contents" variants={columnVariants} custom={1}>
            ...
            <motion.div initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.24, ease: 'easeOut', delay: 0.04 } }} viewport={{ once: true, amount: 0.3 }}>
              ...
              <ul className="text-white text-[11px] sm:text-xs lg:text-sm space-y-1 lg:space-y-1.5 max-h-36 overflow-y-auto pr-1 custom-scrollbar">
                <li><Link href="/products/brass-sheets" className="hover:text-[#FFD600] cursor-pointer transition-colors">Brass Sheets</Link></li>
                <li><Link href="/products/brass-flat" className="hover:text-[#FFD600] cursor-pointer transition-colors">Brass Flat</Link></li>
                <li><Link href="/products/brass-hexagonal" className="hover:text-[#FFD600] cursor-pointer transition-colors">Brass Hexagonal</Link></li>
                <li><Link href="/products/brass-pipe" className="hover:text-[#FFD600] cursor-pointer transition-colors">Brass Pipe</Link></li>
                <li><Link href="/products/brass-round" className="hover:text-[#FFD600] cursor-pointer transition-colors">Brass Round</Link></li>
                <li><Link href="/products/en1a-leaded-freecutting-bright-bars" className="hover:text-[#FFD600] cursor-pointer transition-colors">EN1A Leaded Freecutting Bright Bars</Link></li>
                <li><Link href="/products/mild-steel-bright-bars" className="hover:text-[#FFD600] cursor-pointer transition-colors">Mild Steel Bright Bars</Link></li>
                <li><Link href="/products/ms-bright-hex-bar" className="hover:text-[#FFD600] cursor-pointer transition-colors">MS Bright Hex Bar</Link></li>
                <li><Link href="/products/ms-bright-round-bars" className="hover:text-[#FFD600] cursor-pointer transition-colors">MS Bright Round Bars</Link></li>
                <li><Link href="/products/ms-bright-square-bar" className="hover:text-[#FFD600] cursor-pointer transition-colors">MS Bright Square Bar</Link></li>
            ...
            <motion.div initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.24, ease: 'easeOut', delay: 0.08 } }} viewport={{ once: true, amount: 0.3 }}>
              ...
              <ul className="text-white text-[11px] sm:text-xs lg:text-sm space-y-1 lg:space-y-1.5">
                <li><Link href="/" className="hover:text-[#FFD600] cursor-pointer transition-colors">Home</Link></li>
            ...
            <motion.div initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.24, ease: 'easeOut', delay: 0.1 } }} viewport={{ once: true, amount: 0.3 }}>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold text-xs sm:text-sm">  9999601996, 9999081996</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold text-xs sm:text-sm">sahilnarang111@gmail.com</p>
                  </div>
                </div>
              </div>
              ...
              <motion.div className="hidden lg:block mt-6 lg:mt-8" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.22, ease: 'easeOut', delay: 0.12 } }} viewport={{ once: true, amount: 0.3 }}>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <a href="https://wa.me/  9999601996, 9999081996" className="w-6 h-6 lg:w-8 lg:h-8 bg-green-600 rounded-full flex items-center justify-center hover:bg-green-700 transition-colors">
                    <svg className="w-3 h-3 lg:w-4 lg:h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-xs md:text-sm">
            <div className="text-gray-400 mb-2 md:mb-0 text-center md:text-left">
              © 2025 Narang Steel. All rights reserved.
            </div>
            <div className="flex flex-wrap items-center justify-center md:justify-end text-white text-xs md:text-sm">
              <span>Developed with</span>
              <svg className="w-3 h-3 md:w-4 md:h-4 text-yellow-400 mx-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd"/>
              </svg>
              <span>by</span>
              <a href="https://webintro.in/" target="_blank" rel="noopener noreferrer" className="text-[#FFD600] hover:text-white transition-colors font-medium mx-1">
                Webintro.in
              </a>
              <span>and</span>
              <a href="https://webintro.in/delhi/" target="_blank" rel="noopener noreferrer" className="text-[#FFD600] hover:text-white transition-colors font-medium mx-1">
